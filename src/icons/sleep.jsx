...
export default class Sleep extends React.Component {
  render() {
    return <svg className="icon icon--sleep" width={this.props.width || "24px"} height={this.props.height || "24px"} viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg">
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
            <g stroke={this.props.color || '#000000'} strokeWidth="2">
