...
const Sleep: FunctionComponent<Icon> = ({ color = '#000000', width = '24px', height = '24px' }) => {
  return <svg className="icon icon--sleep" width={width} height={height} viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg">
